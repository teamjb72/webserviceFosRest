...
class ProductsController extends Controller
{
    ...
    public function newAction(Request $request)
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            return $this->redirectToRoute('products_show', array('productcode' => $product->getProductcode()));
        }
     ...
     *
     * @Route("/{productcode}", name="products_show")
     * @Method("GET")
     */
     ...
     *
     * @Route("/{productcode}/edit", name="products_edit")
     * @Method({"GET", "POST"})
     */
    public function editAction(Request $request, Products $product)
    {
        ...
        if ($editForm->isSubmitted() && $editForm->isValid()) {
            ...
            return $this->redirectToRoute('products_edit', array('productcode' => $product->getProductcode()));
        }
     ...
     *
     * @Route("/{productcode}", name="products_delete")
     * @Method("DELETE")
     */
    ...
    private function createDeleteForm(Products $product)
    {
        return $this->createFormBuilder()
            ->setAction($this->generateUrl('products_delete', array('productcode' => $product->getProductcode())))
            ->setMethod('DELETE')
            ->getForm()
        ;
    }
